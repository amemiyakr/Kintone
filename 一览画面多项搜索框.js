//検索したいフィールドの設定値
const FIELD_CODE = '商品名';
const FIELD_CODE2 = '商品コード';
    ...
    kintone.events.on("app.record.index.show", function (event) {
        ...
        function keyword_search(){
            ...
            if(keyword == ""){
                ...
                str_query = '?query='+ FIELD_CODE +' like "' + keyword + '"' + ' or ' + FIELD_CODE2 +' like "' + keyword + '"';
              //str_query = '?query='+ FIELD_CODE1 +' = "' + keyword1 + '" '+ ' or ' +' '+ FIELD_CODE2 +' like"' + keyword2 + '"';
